...
var G__27540 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27540;
continue;
} else {
return ch;
...
var vec__27530 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27530,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27536){
...
return (function() { 
var G__27600__delegate = function (rdr,_){
...
var G__27600 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27601__i = 0, G__27601__a = new Array(arguments.length -  1);
while (G__27601__i < G__27601__a.length) {G__27601__a[G__27601__i] = arguments[G__27601__i + 1]; ++G__27601__i;}
  _ = new cljs.core.IndexedSeq(G__27601__a,0,null);
} 
return G__27600__delegate.call(this,rdr,_);};
G__27600.cljs$lang$maxFixedArity = 1;
G__27600.cljs$lang$applyTo = (function (arglist__27602){
var rdr = cljs.core.first(arglist__27602);
var _ = cljs.core.rest(arglist__27602);
return G__27600__delegate(rdr,_);
});
G__27600.cljs$core$IFn$_invoke$arity$variadic = G__27600__delegate;
return G__27600;
})()
;
});

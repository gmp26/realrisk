...
(defn page1
  ...
  [:main.leading-loose
   [:div.mb-10.font-serif.text-xl
    ...
    [:button.btn-blue.text-3xl.font-sans.py-0.mb-10.mt-10 "Get the real risk >"]
     ...
     [:section.bg-dblue-100.h-screen {:id    (str "page" id)}
      ...
      [:div.h-full.pt-32                                    ; adjust this for mobile
       [:div.flex.flex-row.h-full
        [:div {:key 1 :class "relative flex flex-col justify-between w-2/3 sm:px-20 ml-auto"}
